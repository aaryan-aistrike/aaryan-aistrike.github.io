...
Famous Chollima (CrowdStrike's name; tracked by Microsoft as **Jasper Sleet**, formerly Storm-0287) is a North Korean state-sponsored operation, tracked by CrowdStrike as distinct from the Lazarus-equivalent cluster (Labyrinth Chollima) though part of the same broader DPRK state-sponsored ecosystem, in which DPRK-trained IT workers use stolen and fabricated identities to get hired as remote developers, IT staff, and contractors at Western companies. The scheme has run since at least 2018 and generates hard-currency revenue for the regime - UN estimates put it at up to $600 million a year - while simultaneously creating a long-term insider-access foothold inside victim companies' networks. CrowdStrike's 2025 report tracked 320+ incidents in the trailing 12 months (+220% year-over-year) across 100+ infiltrated companies, most of them US-based technology firms; its 2026 report separately attributes 47% of all "interactive intrusions" targeting the tech sector to this cluster. US DOJ cases describe domestic "laptop farm" facilitators enabling fraudulent hires at 100+ companies using roughly 80 stolen American identities, netting over $5 million.
